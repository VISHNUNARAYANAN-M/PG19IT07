...
?>
	...
	<h2 style="font-style:italic; font-size:30px;text-align: center;">View User</h2>
	...
	<?php
		...
		$ret=mysqli_query($conn,$sql);
            ...
            if(mysqli_num_rows($ret)==0)
            {
                      echo "<div id='card'><h1>No Users are there to view....</h1><form action='admin_home.php'><button type='submit' id='done'>Done</button></form></div>";
