...
<?php
		...
		$sql = "UPDATE  medicine_database SET quanity= quanity+'$qty',expiry_date='$exdate',amount='$amt' WHERE medicine_name='$medname'";


		if ($conn->query($sql) === TRUE) {
		//echo "New record created successfully";
		echo "<div id='card'><p>Stock updated successfully</p><form action='pharmacist_home.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
