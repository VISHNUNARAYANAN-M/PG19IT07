...
?>
	...
	<?php
      ...
      ?>
		...
		<h2 style="font-style:italic; font-size:30px;text-align: center;">Buy Medicine</h2>
			...
			<form action="cal.php" method = "get">
				...
				<div class="row">
					<input type="submit" style="margin-right:600px; margin-top:10px;" value="BUY">
			             ...
			             <div class="row">
					         <input type="submit"  formaction="add.php"style="margin-right:600px; margin-top:10px;" value="add to cart">
				         </div>
