...
?>
	...
	<?php
      ...
      ?>
		...
		<h2 style="font-style:italic; font-size:30px;text-align: center;">Remove from cart</h2>
		
		
		<div class="container">
			<form action="dlt_cart_action.php" method = "get">
				...
				<div class="row">
					<input type="submit" style="margin-right:600px; margin-top:10px;" value="Remove">
				</div>
				
			</form>
			<form action="cart.php">
			   <div class="row">
					<input type="submit" style="margin-right:600px; margin-top:10px;" value="Back">
				</div>
			</form>
