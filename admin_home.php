...
?>
	...
	<?phpt
      ...
      ?>
		...
		<h2 style="font-style:italic; font-size:35px;text-align: center;">Admin Dashboard</h2>
		...
		<div class="grid-container">
			...
			<div ><button type="button" class="btn" onclick="location.href='add_amedicine.php'">Add medicine</button></div>

			<div ><button type="button" class="btn" onclick="location.href='view_astock.php'">View stock</button></div>		
			...
			<div ><button type="button" class="btn" onclick="location.href='purchase_log.php'">Purchase Log</button></div>
