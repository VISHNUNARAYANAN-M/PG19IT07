...
<?php
		...
		$sql = "SELECT * FROM admin_database WHERE admin_phone = '$adminnumber'";
		$result = $conn->query($sql);

		if(mysqli_num_rows($result)>0){
			echo "<div id='card'><p>try with another phone number...</p><form action='add_admin.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
		}
