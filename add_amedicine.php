...
?>
	...
	<?php
      ...
      ?>
		...
		<h2 style="font-style:italic; font-size:30px;text-align: center;">Add Medicine</h2>
		
		
		<div class="container">
			<form action="add_amedicine_action.php" method = "get">
				...
				<div class="row">
					<div class="col-25">
						<label for="lname">Rack number</label>
					</div>
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="rack" placeholder="Rack number...">
					</div>
				</div>
