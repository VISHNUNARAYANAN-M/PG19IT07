...
<?php
		...
		if(mysqli_num_rows($result)>0){
			echo "<div id='card'><p>Medicine Already Exists</p><form action='add_amedicine.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
		}else{
		...
		VALUES ('$medname', '$qty','$exdate','$amt','$rack')";
		     ...
		     if ($conn->query($sql) === TRUE) {
				...
				echo "<div id='card'><p>Medicine Successfully Added</p><form action='admin_home.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
