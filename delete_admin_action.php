...
<?php
		...
		$sql="SELECT * FROM admin_database WHERE admin_id='$adminid'";
		$ret=mysqli_query($conn,$sql);
            
			
            if(mysqli_num_rows($ret)==0)
            {
                      echo "<div id='card'><h1>No admin of such id is there....</h1><form action='admin_home.php'><button type='submit' id='done'>Done</button></form></div>";
